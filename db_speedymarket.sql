...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 12 Septembre 2016 à 08:17
...
--
-- Base de données :  `db_speedymarket`
--
...
('VIAPOI_POI_001', 'VIAPOI_POI'),
('VIAPOI_POI_002', 'VIAPOI_POI'),
('VIAPOI_POI_003', 'VIAPOI_POI'),
('VIAPOI_POI_004', 'VIAPOI_POI'),
('VIAPOI_POI_005', 'VIAPOI_POI'),
...
('VIAPOI_VIA_004', 'VIAPOI_VIA'),
('VIAPOI_VIA_005', 'VIAPOI_VIA'),
('VIAPOI_VIA_006', 'VIAPOI_VIA'),
('VIAPOI_VIA_007', 'VIAPOI_VIA'),
...
('BOISSO_ALC_001', 'Vin blanc', 'Vin blanc de Jurançon', 5, 10, NULL, NULL, NULL),
('BOISSO_ALC_002', 'Vin rouge', 'Vin rouge l''éscudé Béarn', 10, 2, NULL, NULL, NULL),
('BOISSO_ALC_003', 'Vin rosé', 'Vin rosé l''éscudé Béarn', 5, 5, NULL, NULL, NULL),
...
('BOISSO_ALC_007', 'Cidre', 'Cidre du Pays Basque', 55, 2, NULL, NULL, NULL),
...
('BOISSO_ALC_010', 'Bière Béarnaise', 'Bière Béarnaise de la Brasserie Béarnaise', 26, 5, NULL, NULL, NULL),
...
('BOISSO_NON_010', 'Limonade', 'Limonade', 100, 1, NULL, NULL, NULL),
...
('BOISSO_NON_014', 'Gazpacho', 'Gazpacho', 100, 2, NULL, NULL, NULL),
...
('BOISSO_NON_018', 'Sirop de grenadine', 'Sirop de grenadine', 100, 2, NULL, NULL, NULL),
...
('BOISSO_NON_028', 'Jus pomme-kiwi', 'Jus pomme-kiwi', 100, 2, NULL, NULL, NULL),
...
('CONBOC_BOC_001', 'Confiture de figue', 'Miam miam la bonne confiote de bonne maman', 42, 3, NULL, 'bio', NULL),
('CONBOC_BOC_002', 'Confiture de coing', 'Olé olé la confiture', 50, 3, NULL, 'non-bio', NULL),
('CONBOC_BOC_003', 'Paté de campagne', 'Avec des vrais morceaux de lapin à l''interieur', 22, 1, NULL, 'non-bio', NULL),
('CONBOC_BOC_004', 'Terrine de canard', 'Le plaisir de la viande, les plumes en moins', 99, 3, NULL, 'non-bio', NULL),
...
('CONBOC_BOC_009', 'Moutarde', 'Celle de Mauléon, pas celle de Dijon', 44, 3, NULL, 'bio', NULL),
...
('CONBOC_CON_003', 'Aubergines', NULL, 50, 3, NULL, 'Bio', NULL),
...
('CONBOC_CON_007', 'Tomates séchées', NULL, 50, 3, NULL, 'Bio', NULL),
('CONBOC_CON_008', 'Haricots rouges', NULL, 50, 3, NULL, 'Non bio', NULL),
('CONBOC_CON_009', 'Pois chiches', NULL, 50, 3, NULL, 'Bio', NULL),
('CONBOC_CON_010', 'Haricots verts', NULL, 50, 3, NULL, 'Non bio', NULL),
('CONBOC_CON_011', 'Champignons', NULL, 50, 3, NULL, 'Bio', NULL),
...
('FRULEG_FRU_001', 'Fraise', 'Fruit rouge', 25, 4, NULL, NULL, NULL),
('FRULEG_FRU_002', 'Banane', 'Fruit exotique', 50, 4, NULL, NULL, NULL),
('FRULEG_FRU_003', 'Pomme', 'Fruit classique', 70, 3, NULL, NULL, NULL),
('FRULEG_FRU_004', 'Poire', 'Fruit classique', 46, 3, NULL, NULL, NULL),
('FRULEG_FRU_005', 'Ananas', 'Fruit exotique', 24, 7, NULL, NULL, NULL),
('FRULEG_FRU_006', 'Melon', 'Fruit exotique', 10, 4, NULL, NULL, NULL),
...
('FRULEG_FRU_010', 'Pamplemousse', 'Fruit exotique', 24, 4, NULL, NULL, NULL),
('FRULEG_FRU_011', 'Kiwi', 'Fruit exotique', 80, 3, NULL, NULL, NULL),
...
('FRULEG_LEG_002', 'Potimarron', NULL, 25, 4, NULL, NULL, NULL),
...
('FRULEG_LEG_006', 'Carrotte', NULL, 25, 6, NULL, NULL, NULL),
...
('FRULEG_LEG_012', 'Aubergine', NULL, 53, 6, NULL, NULL, NULL),
('FRULEG_LEG_013', 'Poivron', NULL, 25, 4, NULL, NULL, NULL),
('FRULEG_LEG_014', 'Laitue', NULL, 45, 4, NULL, NULL, NULL),
('FRULEG_LEG_015', 'Piment', NULL, 70, 3, NULL, NULL, NULL),
('VIAPOI_POI_001', 'Silure', 'En provenance de sites SEVESO', 56, 12, NULL, '100% OGM', NULL),
('VIAPOI_POI_002', 'Éperlans', 'À fricasser', 1280, 14, NULL, NULL, NULL),
('VIAPOI_POI_003', 'Dorade', 'Aux câpres ', 30, 34, NULL, NULL, NULL),
('VIAPOI_POI_004', 'Baleine', 'Uniquement entière', 1, 25, NULL, NULL, NULL),
('VIAPOI_POI_005', 'Requin', 'Mangeur d''homme', 1, 50, NULL, 'Bio', NULL),
('VIAPOI_POI_006', 'Truites', 'Truites d''élevage', 51, 22, NULL, NULL, NULL),
('VIAPOI_POI_007', 'Carpe', 'Lac de Biscarosse', 16, 14, NULL, 'Bio', NULL),
('VIAPOI_POI_008', 'Filet de cabillaud', 'Mer Baltique', 89, 20, NULL, '100% colin', NULL),
...
('VIAPOI_POI_012', 'Morue', 'La mère et les soeurs de Karim', 36, 14, NULL, 'Kascher', NULL),
('VIAPOI_POI_013', 'Sardines', 'Serrées au fond de leur boite', 114, 6, NULL, 'En boite', NULL),
('VIAPOI_POI_014', 'Pavé de saumon', 'Saumon d''élevage', 21, 30, NULL, 'Né en piscine', NULL),
('VIAPOI_VIA_001', 'Boeuf', 'Viande bovine française', 20, 18, NULL, 'Label Rouge', NULL),
('VIAPOI_VIA_002', 'Jambon blanc', 'Jambon blanc', 45, 43, NULL, NULL, NULL),
('VIAPOI_VIA_003', 'Lardon fumé', 'Porc breton ', 6, 9, NULL, 'Viande française', NULL),
('VIAPOI_VIA_004', 'Terrine de canard', 'Canard WC', 15, 5, NULL, NULL, NULL),
('VIAPOI_VIA_005', 'Lapin ', 'Lapinou tout mignon égorgé sauvagement', 128, 14, NULL, 'Sauvage, c''est bon', NULL),
('VIAPOI_VIA_006', 'Steak de mammouth', 'Décongelé', 20, 152, NULL, NULL, NULL),
('VIAPOI_VIA_007', 'Rôti de rat', 'Origine Pau', 3980, 2, NULL, NULL, NULL),
('VIAPOI_VIA_008', 'Poulet fermier', 'Poulet femier entier', 100, 12, NULL, 'Label Rouge', NULL),
('VIAPOI_VIA_009', 'Canard des Landes', 'Canard des Landes', 34, 14, NULL, NULL, NULL),
('VIAPOI_VIA_010', 'Escalopes de Dinde', 'Escalopes de Dinde', 1228, 42, NULL, 'Jacasseuse', NULL),
('VIAPOI_VIA_011', 'Blancs de Poulet', 'Blancs de Poulet', 998, 15, NULL, NULL, NULL),
('VIAPOI_VIA_012', 'Magrets de canard', 'Magrets de canard x3', 35, 35, NULL, 'Gras', NULL),
('VIAPOI_VIA_013', 'Cuisses d''enfants', 'Séquestrés 3 mois en cave humide', 12, 140, NULL, 'Bio', NULL),
